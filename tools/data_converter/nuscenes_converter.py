...
def create_nuscenes_infos(root_path,
    ...
    train_nusc_infos, val_nusc_infos = _fill_trainval_infos(
        nusc, train_scenes, val_scenes, test, max_sweeps=max_sweeps, max_radar_sweeps=max_radar_sweeps)  #获取训练、验证的nusc_sensor_info
...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample): #按sample来抽取sensor数据，对应实际车辆的每一帧
        # i_ += 1 
        # if i_ > 6: 
        #     break
